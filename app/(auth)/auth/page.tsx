...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex mt-7">
      <div className="w-full max-w-3xl p-3 mx-auto flex flex-col lg:flex-row">
        <div>
          {/* Back button */}
          <div className="mb-8 lg:mb-12 cursor-pointer" onClick={() => router.push('/')}>
            <ChevronLeft className="text-gray-500 w-6 h-6 sm:w-8 sm:h-8 border-2 rounded-full p-1" />
          </div>
